...
<table border="1" style="border-collapse: collapse; width: 100%; border: 1px solid #045771; font-size: 14px;">
    ...
    <tr>
	<td style="padding: 6px; background-color: #045771; color: #FFF; font-weight: bold;">Fotografia</td>
	<td style="padding: 6px; background-color: #045771; color: #FFF; font-weight: bold;">Matricula</td>
	<td style="padding: 6px; background-color: #045771; color: #FFF; font-weight: bold;">Email</td>
	<td style="padding: 6px; background-color: #045771; color: #FFF; font-weight: bold;">Telefone</td>
	<td style="padding: 6px; background-color: #045771; color: #FFF; font-weight: bold;">Habilitação</td>
    ...
    <tr>
	<td style="padding: 6px 6px 10px;">{cine7_projetos___DiretorFotografia}</td>
	<td style="padding: 6px 6px 10px;">{cine7_projetos___MatriculaDiretorFotografia}</td>
	<td style="padding: 6px 6px 10px;">{cine7_projetos___EmailDiretorFotografia}</td>
	<td style="padding: 6px 6px 10px;">{cine7_projetos___TelefoneDiretorFotografia}</td>
    ...
    <tr>
	<td style="padding: 6px 6px 10px;">{arte}</td>
	<td style="padding: 6px 6px 10px;">{arte-matricula}</td>
	<td style="padding: 6px 6px 10px;">{arte-email}</td>
	<td style="padding: 6px 6px 10px;">{arte-telefone}</td>
	<td style="padding: 6px 6px 10px;">{arte-habilitacao}</td>
    </tr>
</table>
