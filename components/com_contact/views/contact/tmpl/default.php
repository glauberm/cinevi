...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Person">
	...
	<?php if ($this->params->get('presentation_style') == 'plain'):?>
		<?php  echo '<h1 class="page-header">Fale com o Departamento</h1>';  ?>
	<?php endif; ?>
	...
	<?php if ($this->params->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style') == 'plain'):?>
			<?php echo '<h3 class="hidden">' . JText::_('COM_CONTACT_EMAIL_FORM') . '</h3>';  ?>
		<?php endif; ?>
	...
	<?php if ($this->params->get('show_articles') && $this->contact->user_id && $this->contact->articles) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style') == 'plain'):?>
			<?php echo '<h3 class="hidden">' . JText::_('JGLOBAL_ARTICLES') . '</h3>';  ?>
		<?php endif; ?>
	...
	<?php if ($this->params->get('show_profile') && $this->contact->user_id && JPluginHelper::isEnabled('user', 'profile')) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style') == 'plain'):?>
			<?php echo '<h3 class="hidden">' . JText::_('COM_CONTACT_PROFILE') . '</h3>';  ?>
		<?php endif; ?>
	...
	<?php if ($this->contact->misc && $this->params->get('show_misc')) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style') == 'plain'):?>
			<?php echo '<h3 class="hidden">' . JText::_('COM_CONTACT_OTHER_INFORMATION') . '</h3>';  ?>
		<?php endif; ?>
