<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:21153:"<!DOCTYPE html>
<!-- ************************************************************ -->
...
<head>
	...
	<title>Administrativo - Departamento de Cinema e Vídeo</title>
	<link href="http://www.cinevi.uff.br//cinevi2/index.php?option=com_content&amp;view=article&amp;id=5&amp;Itemid=127&amp;lang=br" rel="canonical" />
	...
	<link rel="stylesheet" href="/cinevi2/templates/cinevi/css/template.css?8e0e8518a4f980c39733acae4d2f5191" />
	<link rel="stylesheet" href="/cinevi2/templates/cinevi/css/Buenard.css?8e0e8518a4f980c39733acae4d2f5191" />
	<link rel="stylesheet" href="/cinevi2/templates/cinevi/css/Merriweather.css?8e0e8518a4f980c39733acae4d2f5191" />
	<link rel="stylesheet" href="/cinevi2/templates/cinevi/css/user.css?8e0e8518a4f980c39733acae4d2f5191" />
	...
	<script src="/cinevi2/templates/cinevi/js/template.js?8e0e8518a4f980c39733acae4d2f5191"></script>
	<script src="/cinevi2/templates/cinevi/js/banner.js?8e0e8518a4f980c39733acae4d2f5191"></script>
...
<body class="site com_content view-article no-layout no-task itemid-127">
	...
	<form action="http://localhost/cinevi2/index.php?option=com_content&amp;view=article&amp;id=5&amp;Itemid=127&amp;lang=br" method="post" id="login-form" class="form-inline">
		<div class="userdata">
			<div class="login-icon-wrap">
				...
				<div class="login-data">
					...
					<input type="hidden" name="return" value="aHR0cDovL2xvY2FsaG9zdC9jaW5ldmkyL2luZGV4LnBocD9vcHRpb249Y29tX2NvbnRlbnQmdmlldz1hcnRpY2xlJmlkPTUmSXRlbWlkPTEyNyZsYW5nPWJy" />
			...
			<input type="text" name="q" id="mod-finder-searchword137" class="search-query" size="255" value="" placeholder="Pesquisar..."/>		</div>
						...
						<input type="hidden" name="option" value="com_finder" /><input type="hidden" name="view" value="search" /><input type="hidden" name="Itemid" value="184" /><input type="hidden" name="lang" value="br" />	</div>
								...
								<div class="nav-collapse">
									<ul class="nav menu">
<li class="item-101 default"><a href="/cinevi2/index.php?option=com_content&amp;view=featured&amp;Itemid=101&amp;lang=br" >Home</a></li><li class="item-121 active deeper parent"><a href="/cinevi2/index.php?option=com_content&amp;view=category&amp;id=9&amp;Itemid=121&amp;lang=br" >Curso</a><ul class="nav-filho"><li class="item-125"><a href="/cinevi2/index.php?option=com_content&amp;view=article&amp;id=2&amp;Itemid=125&amp;lang=br" >História</a></li><li class="item-128"><a href="/cinevi2/index.php?option=com_content&amp;view=article&amp;id=3&amp;Itemid=128&amp;lang=br" >Bacharelado</a></li><li class="item-126"><a href="/cinevi2/index.php?option=com_content&amp;view=article&amp;id=4&amp;Itemid=126&amp;lang=br" >Licenciatura</a></li><li class="item-127 current active"><a href="/cinevi2/index.php?option=com_content&amp;view=article&amp;id=5&amp;Itemid=127&amp;lang=br" >Administrativo</a></li></ul></li><li class="item-114 deeper parent"><span class="nav-header ">Espaço Discente</span>
...
<div class="icons">
				...
				<a class="btn dropdown-toggle" data-toggle="dropdown" href="#"> <span class="icon-cog"></span><span class="caret"></span> </a>
								<ul class="dropdown-menu">
											<li class="print-icon"> <a href="/cinevi2/index.php?option=com_content&amp;view=article&amp;id=5:administrativo&amp;catid=9&amp;Itemid=127&amp;tmpl=component&amp;print=1&amp;layout=default&amp;page=&amp;lang=br" title="Imprimir o artigo < Administrativo >" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow"><span class="icon-print"></span>Imprimir</a> </li>
																<li class="email-icon"> <a href="/cinevi2/index.php?option=com_mailto&amp;tmpl=component&amp;template=cinevi&amp;link=23bdb1a436a238670be3cf8657b0738c45ab8274&amp;lang=br" title="Envie este link a um amigo" onclick="window.open(this.href,'win2','width=400,height=350,menubar=yes,resizable=yes'); return false;" rel="nofollow"><span class="icon-envelope"></span>Email</a> </li>
														</ul>
			</div>
	...
	class="caption" title="Prédio do IACS atualmente"	src="images/04920021iacs.jpg" alt="Prédio do IACS atualmente" itemprop="image"/> </div>
				<div itemprop="articleBody">
		<p>Informações do corpo administrativo do departamento.</p>
 
<h3>Coordenação do Curso de Bacharelado</h3>
<p>Mauro Duque Estrada Moderno <br /><strong>Coordenador do Curso de Bacharelado de Cinema e Audiovisual</strong></p>
<p>Eduardo Gregório <br /><strong>Funcionário da Coordenação do Curso de Bacharelado de Cinema e Audiovisual</strong></p>
<h3>Coordenação do Curso de Licenciatura</h3>
<p>Mauricio Braganca<br /><strong>Coordenador do Curso de Licenciatura de Cinema e Audiovisual</strong></p>
<p>Profª. Eliany Salvatierra Machado <br /><strong>Vice-Coordenadora do Curso de Licenciatura de Cinema e Audiovisual</strong></p>
<p>Mariana Almada <br /><strong>Funcionário da Coordenação do Curso de Licenciatura de Cinema e Audiovisual</strong></p>
<h3>Departamento</h3>
<p>Profª. India Mara Martins<br /> <strong>Chefe do Departamento de Cinema e Vídeo</strong></p>
<p>Prof. Fabian Nunez <br /> <strong>Vice-chefe do Departamento de Cinema e Vídeo</strong></p>
<p>Beatriz de Resende Chamberlini e Jorge Paulo Corrêa de Vallejo <br /><strong>Funcionários do Departamento de Cinema e Vídeo</strong></p>	</div>

						
	
<ul class="pager pagenav">
	<li class="next">
		<a href="/cinevi2/index.php?option=com_content&amp;view=article&amp;id=2:historia&amp;catid=9&amp;Itemid=125&amp;lang=br" rel="next">
