<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:28898:"<!DOCTYPE html>
<!-- ************************************************************ -->
...
<head>
	...
	<link href="http://www.cinevi.uff.br//cinevi2/index.php?oi=&amp;lang=br" rel="canonical" />
	...
	<link rel="stylesheet" href="/cinevi2/templates/cinevi/css/template.css?577284af0794743ddece1678a8311e62" />
	<link rel="stylesheet" href="/cinevi2/templates/cinevi/css/Buenard.css?577284af0794743ddece1678a8311e62" />
	<link rel="stylesheet" href="/cinevi2/templates/cinevi/css/Merriweather.css?577284af0794743ddece1678a8311e62" />
	<link rel="stylesheet" href="/cinevi2/templates/cinevi/css/user.css?577284af0794743ddece1678a8311e62" />
	...
	<script src="/cinevi2/templates/cinevi/js/template.js?577284af0794743ddece1678a8311e62"></script>
	<script src="/cinevi2/templates/cinevi/js/banner.js?577284af0794743ddece1678a8311e62"></script>
...
<body class="site com_content view-featured no-layout no-task itemid-101">
	...
	<form action="http://localhost/cinevi2/index.php?oi=&amp;lang=br" method="post" id="login-form" class="form-inline">
		<div class="userdata">
			<div class="login-icon-wrap">
				...
				<div class="login-data">
					...
					<input type="hidden" name="return" value="aHR0cDovL2xvY2FsaG9zdC9jaW5ldmkyL2luZGV4LnBocD9vaT0mbGFuZz1icg==" />
...
<ul class="nav-filho"><li class="item-220"><a href="/cinevi2/index.php?option=com_fabrik&amp;view=list&amp;listid=6&amp;Itemid=220&amp;lang=br" >Equipamentos</a></li><li class="item-210"><a href="/cinevi2/index.php?option=com_fabrik&amp;view=form&amp;formid=6&amp;Itemid=210&amp;lang=br" >Cadastrar Equipamento</a></li><li class="item-222"><a href="/cinevi2/index.php?option=com_fabrik&amp;view=form&amp;formid=7&amp;Itemid=222&amp;lang=br" >Solicitar Equipamento</a></li></ul></li><li class="item-124"><a href="/cinevi2/index.php?option=com_content&amp;view=article&amp;id=7&amp;Itemid=124&amp;lang=br" >Comissões</a></li><li class="item-120"><a href="/cinevi2/index.php?option=com_content&amp;view=article&amp;id=6&amp;Itemid=120&amp;lang=br" >Contatos</a></li><li class="item-264"><a href="/cinevi2/index.php?option=com_tags&amp;view=tag&amp;id[0]=2&amp;types[0]=2&amp;Itemid=264&amp;lang=br" >Comissão de Produção</a></li><li class="item-265"><a href="/cinevi2/index.php?option=com_tags&amp;view=tag&amp;layout=list&amp;id[0]=2&amp;types[0]=2&amp;Itemid=265&amp;lang=br" >Comissões</a></li></ul>
	...
	<img src="/cinevi2/images/banners-mini/ossobreviventes2.jpg" alt="ossobreviventes2.jpg" width="100" height="27" /></div>
		</div>
...
<p>Os alunos que não puderem comparecer nas datas marcadas poderão fazer as inscrições por meio de procurador (munido de procuração simples assinada pelo estudante) ou a partir do dia 29/08 (começo do ajuste UFF). Qualquer dúvida, basta entrar em contato pelos emails <span id="cloaka92d409cdd95dd61841c4e85789ee872">Este endereço de email está sendo protegido de spambots. Você precisa do JavaScript ativado para vê-lo.</span><script type='text/javascript'>
				document.getElementById('cloaka92d409cdd95dd61841c4e85789ee872').innerHTML = '';
				var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
				var path = 'hr' + 'ef' + '=';
				var addya92d409cdd95dd61841c4e85789ee872 = '&#101;l&#105;&#97;nn&#101;.&#105;v&#111;' + '&#64;';
				addya92d409cdd95dd61841c4e85789ee872 = addya92d409cdd95dd61841c4e85789ee872 + 'gm&#97;&#105;l' + '&#46;' + 'c&#111;m';
				var addy_texta92d409cdd95dd61841c4e85789ee872 = '&#101;l&#105;&#97;nn&#101;.&#105;v&#111;@gm&#97;&#105;l.c&#111;m ';document.getElementById('cloaka92d409cdd95dd61841c4e85789ee872').innerHTML += '<a ' + path + '\'' + prefix + ':' + addya92d409cdd95dd61841c4e85789ee872 + '\'>'+addy_texta92d409cdd95dd61841c4e85789ee872+'<\/a>';
		</script>e/ou <a href="mailto:ggx@vm.uff.br."><span id="cloakc10e8495aab4408c13dbbd6672e2e0e6">Este endereço de email está sendo protegido de spambots. Você precisa do JavaScript ativado para vê-lo.</span><script type='text/javascript'>
				document.getElementById('cloakc10e8495aab4408c13dbbd6672e2e0e6').innerHTML = '';
				var prefix = '&#109;a' + 'i&#108;' + '&#116;o';
				var path = 'hr' + 'ef' + '=';
				var addyc10e8495aab4408c13dbbd6672e2e0e6 = 'ggx' + '&#64;';
				addyc10e8495aab4408c13dbbd6672e2e0e6 = addyc10e8495aab4408c13dbbd6672e2e0e6 + 'vm' + '&#46;' + '&#117;ff' + '&#46;' + 'br';
				var addy_textc10e8495aab4408c13dbbd6672e2e0e6 = 'ggx' + '&#64;' + 'vm' + '&#46;' + '&#117;ff' + '&#46;' + 'br';document.getElementById('cloakc10e8495aab4408c13dbbd6672e2e0e6').innerHTML += '<a ' + path + '\'' + prefix + ':' + addyc10e8495aab4408c13dbbd6672e2e0e6 + '\'>'+addy_textc10e8495aab4408c13dbbd6672e2e0e6+'<\/a>';
		</script>.</a></p>
